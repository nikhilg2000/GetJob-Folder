...
app.get('/', function (req, res) {
   res.redirect('/GetJob_Login.html') 
})
...
app.post('/GetJob_Registration', function(req, res){
...
app.post('/GetJob_Login', function(req, res){
	conn.query("SELECT * FROM users WHERE user_email=?", req.body.email, function(error, results, fields){
		var body = req.body;
		var success = null;
		var message = "";
